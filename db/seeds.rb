...
users = User.create!([
  ...
  { username: 'test', password: 'password', role: 0, first_name: 'John', last_name: 'Wick', preferences: 'Gym, Pool' },
  { username: 'test1', password: 'password', role: 0, first_name: 'Harry', last_name: 'Potter', preferences: 'Tennis Court' }
])

# Attach images to users
users[1].image.attach(io: File.open("/mnt/c/Users/a_sae/OneDrive/Pictures/john-wick.jpg"), filename: 'john-wick.jpg', content_type: 'image/jpeg')
users[2].image.attach(io: File.open("/mnt/c/Users/a_sae/OneDrive/Pictures/harry-potter.jpg"), filename: 'harry-potter.jpg', content_type: 'image/jpeg')
...
Reservation.create!([
  { user_id: users[1].id, room_id: rooms[0].id, check_in: Date.today, check_out: Date.today + 3 }, # John Wick
  { user_id: users[2].id, room_id: rooms[2].id, check_in: Date.today + 1, check_out: Date.today + 4 } # Harry Potter
])
